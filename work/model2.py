...
class SWA(Callback):
    ...
    def on_train_end(self, logs=None):
        ...
        self.model.save_weights(oPath + "model2_swa.h5")
...
class Classifier(object):
    ...
    def modelBuilding(self):
        ...
        self.pretrainedNet = clfs[0](input_shape=self.inputShape, weights="imagenet", include_top=False)
    ...
    def modelFitting(self):
        ...
        self.clf.fit(
            ...
            callbacks=[
                ...
                CSVLogger(oPath + "history2.csv", separator=',', append=False),
                SWA(self.epochs - 5),
            ],
        )
